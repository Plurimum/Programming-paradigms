...
const expression = (function () {
    ...
    Op.prototype.toString = function () {
        return this.getOperands().join(" ") + " " + this.operator;
    };
    ...
    function Operation(maker, calculationAlg, operator, diffAlg, simplifyAlg) {
    ...
    Operation.prototype = Op.prototype;

    const AbstractOperation = (calculationAlg, operator, diffAlg, howToSimplify) => {
        const result = function () {
            Op.apply(this, arguments);
        };
        result.prototype = new Operation(result, calculationAlg, operator, diffAlg, howToSimplify);
        return result;
    };
    ...
    const
        ...
        ArcTan2 = AbstractOperation( //undone
